  ...
  return (
    <div className="my-10 dark:bg-slate-900">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-10">
        ...
        <div className="h-[200px] bg-red-400 overflow-hidden relative">
          <img
            className="h-full w-full object-cover"
            src="https://i.ibb.co/pYNFmxb/Adobe-Stock-298277186-bscsck.jpg"
            alt=""
          />
          <div className="h-full w-full absolute left-0 top-0  flex items-center justify-center bg-[#00000038] hover:bg-[#00000070] cursor-pointer transition-all duration-300">
