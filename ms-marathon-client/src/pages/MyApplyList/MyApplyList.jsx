                ...
                <form className="w-full">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className=" flex-1 w-full p-4 ps-10 text-sm rounded-lg bg-white text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-primary sm:text-sm/6 dark:bg-slate-900 dark:text-white"
                      placeholder="Search..."
                      required
                    />
                    <span
